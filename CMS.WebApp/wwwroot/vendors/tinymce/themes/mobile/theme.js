...
(function () {
  ...
  var adt$4 = Adt.generate([{ required: ["data"] }, { external: ["data"] }, { optional: ["data"] }, { group: ["data"] }]);
  ...
  var makeApi = function (f) {
    return markAsSketchApi(function (component) {
      ...
      return f.apply(void 0, __spreadArray([component.getApis(), component], rest));
    }, f);
  };
  ...
  var base = function (partSchemas, partUidsSchemas) {
    ...
    return ps
      .concat([required$1("uid"), defaulted("dom", {}), defaulted("components", []), snapshot("originalSpec"), defaulted("debug.sketcher", {})])
  ...
  var promise = function () {
    ...
    var asap =
      Promise.immediateFn ||
      (typeof anyWindow.setImmediate === "function" && anyWindow.setImmediate) ||
      function (fn) {
  ...
  var field = function (name, placeholder) {
    var inputSpec = record(
      Input.sketch({
        ...
        inputBehaviours: derive$2([Composing.config({ find: Optional.some }), Tabstopping.config({}), Keying.config({ mode: "execution" })]),
        selectOnFocus: false,
      })
    );
  ...
  var schema$6 = objOf([
    field$2(
      ...
      "dom",
      required$2(),
      objOf([required$1("tag"), defaulted("styles", {}), defaulted("classes", []), defaulted("attributes", {}), option("value"), option("innerHtml")])
    ),
  ...
  var builder$2 = function (detail) {
    return {
      ...
      domModification: __assign(__assign({}, detail.domModification), {
        attributes: __assign(
          __assign(__assign({ role: detail.toggling.isSome() ? "menuitemcheckbox" : "menuitem" }, detail.domModification.attributes), { "aria-haspopup": detail.hasSubmenu }),
      ...
      behaviours: SketchBehaviours.augment(detail.itemBehaviours, [
        ...
        config("item-type-events", __spreadArray(__spreadArray([], pointerEvents()), [run(mouseover(), onHover), run(focusItem(), Focusing.focus)])),
      ]),
      components: detail.components,
      eventOrder: detail.eventOrder,
    };
  ...
  var TransitionSchema = [
    ...
    onHandler("onFinish"),
    requiredOf("routes", setOf(Result.value, setOf(Result.value, objOfOnly([optionObjOfOnly("transition", [required$1("property"), required$1("transitionClass")])])))),
  ];
  ...
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Optional.some(
        SimRange.create(SugarElement.fromDom(firstRng.startContainer), firstRng.startOffset, SugarElement.fromDom(lastRng.endContainer), lastRng.endOffset)
      );
    } else {
      return Optional.none();
    }
  ...
  var settingsSchema = objOfOnly([requiredFunction("triggerEvent"), defaulted("stopBackspace", true)]);
