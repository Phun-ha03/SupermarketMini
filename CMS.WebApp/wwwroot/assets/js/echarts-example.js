...
var getItemFromStore = function getItemFromStore(key, defaultValue) {
    var store =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : localStorage;
...
var getStoreSpace = function getStoreSpace() {
    var store =
        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : localStorage;
    return parseFloat(
        (
                ...
                visualMap: {
                    ...
                    inRange: {
                        color: [
                            ...
                            utils.rgbaColor(utils.getColors().success, 1), // utils.rgbaColor(utils.getColors()['warning'], 1),
    ...
    if ($lineMarkerChartEl) {
        ...
        var getDefaultOptions = function getDefaultOptions() {
            return {
                color: [
                    utils.getColor("primary"),
                    utils.getColor("warning"), // utils.getColor('danger')
                ],
                legend: {
                    data: [
                        {
                        ...
                        data: [
                            {
                                name: "Precipitation",
                                value: [
                                    2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 75.6, 82.2, 48.7,
                                    18.8, 6.0, 2.3,
                                ],
                                itemStyle: {
                                    color: utils.getColor("primary"),
                            ...
                            },
                            {
                                name: "Evaporation",
                                value: [
                                    2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 35.6, 62.2, 32.6,
                                    20.0, 6.4, 3.3,
                                ],
                                itemStyle: {
                                    color: utils.getColor("warning"),
