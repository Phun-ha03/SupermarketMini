...
var breakpoints = { xs: 0, sm: 576, md: 768, lg: 992, xl: 1200, xxl: 1540 },
    ...
    getItemFromStore = function (e, o) {
        var r =
            2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : localStorage;
        try {
    ...
    getStoreSpace = function () {
        var t =
            0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : localStorage;
        return parseFloat(
            (escape(encodeURIComponent(JSON.stringify(t))).length / 1048576).toFixed(2)
        );
    },
    getDates = function (o, t) {
        var r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 864e5;
                ...
                return {
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            type: "bar",
                            data: [
                                2.6, 5.9, 9, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8,
                                6, 2.3,
                            ],
                            itemStyle: {
                        ...
                        },
                        {
                            ...
                            yAxisIndex: 1,
                            data: [
                                2, 2.2, 3.3, 4.5, 6.3, 10.2, 20.3, 23.4, 23, 16.5, 12,
                                6.2,
                            ],
                    ...
                    series: [
                        {
                            ...
                            data: [
                                -0.12, -0.19, 0.2, 0.44, -0.23, 0.08, -0.17, 0.47, -0.36,
                                0.18,
                            ],
                        },
                    ],
                ...
                return {
                    ...
                    tooltip: {
                        ...
                        position: function (t, e, o, r, a) {
                            var i = { top: 60 };
                            return (
                                (i[["left", "right"][+(t[0] < a.viewSize[0] / 2)]] = 5), i
                            );
                        },
                    },
                    ...
                    series: [
                        {
                            ...
                            radius: ["40%", "70%"],
                            center:
                                window.innerWidth < 530 ? ["65%", "55%"] : ["50%", "55%"],
                            avoidLabelOverlap: !1,
                            itemStyle: {
                                borderRadius: 10,
    ...
    echartsHeatMapChartInit = function () {
        for (
            ...
            for (var l = 0; l < 12; l += 1) a.push([l, i, utils.getRandomNumber(5, 12)]);
        e &&
            ((t = utils.getData(e, "options")),
            (e = window.echarts.init(e)),
            echartSetOption(e, t, function () {
    ...
    echartsHeatMapSingleSeriesChartInit = function () {
        for (
            ...
            for (var l = 0; l < 12; l += 1) a.push([l, i, utils.getRandomNumber(1, 12)]);
        e &&
            ((t = utils.getData(e, "options")),
            (e = window.echarts.init(e)),
            echartSetOption(e, t, function () {
    ...
    echartsLineAreaChartInit = function () {
        ...
        a &&
            ...
            (o = [1142, 1160, 1179, 946, 1420, 1434, 986, 1247, 1051, 1297, 927, 1282]),
            (r = function (t) {
                return '\n      <div>\n          <h6 class="fs--1 text-700 mb-0">\n            <span class="fas fa-circle me-1" style=\'color:'
                    .concat(t[0].borderColor, "'></span>\n            ")
                    .concat(t[0].name, " : ")
    ...
    data1 = [
        { value: 1048, name: "Starter", itemStyle: { color: utils.getColor("danger") } },
        { value: 735, name: "Basic", itemStyle: { color: utils.getColor("primary") } },
        {
            value: 580,
            name: "Optimal",
            itemStyle: { color: utils.getColor("secondary") },
        },
        { value: 484, name: "Business", itemStyle: { color: utils.getColor("warning") } },
        { value: 300, name: "Premium", itemStyle: { color: utils.getColor("success") } },
        { value: 300, name: "Platinum", itemStyle: { color: utils.getColor("info") } },
    ],
    data2 = [
        {
            value: 1048,
        ...
        { value: 735, name: "Youtube", itemStyle: { color: utils.getColor("danger") } },
        { value: 580, name: "Twitter", itemStyle: { color: utils.getColor("info") } },
        { value: 484, name: "Linkedin", itemStyle: { color: utils.getColor("success") } },
                    ...
                    radar: [
                        {
                            ...
                            shape: "circle",
                            center:
                                window.innerWidth < 992 ? ["50%", "30%"] : ["25%", "50%"],
                            indicator: [
                                { name: "Admin", max: 6500 },
                                { name: "Tech", max: 16e3 },
                        ...
                        },
                        {
                            ...
                            radius: window.innerWidth < 576 ? 90 : 120,
                            center:
                                window.innerWidth < 992 ? ["50%", "75%"] : ["75%", "50%"],
                            splitLine: {
                                lineStyle: {
                                    color: utils.rgbaColor(utils.getGrays()[700]),
                                },
                            ...
                            data: [
                                {
                                    name: "Precipitation",
                                    value: [
                                        2.6, 5.9, 9, 26.4, 28.7, 70.7, 75.6, 82.2, 48.7,
                                        18.8, 6, 2.3,
                                    ],
                                    itemStyle: { color: utils.getColor("primary") },
                                    areaStyle: {
                                ...
                                },
                                {
                                    name: "Evaporation",
                                    value: [
                                        2, 4.9, 7, 23.2, 25.6, 76.7, 35.6, 62.2, 32.6, 20,
                                        6.4, 3.3,
                                    ],
                                    itemStyle: { color: utils.getColor("warning") },
                                    areaStyle: {
            ...
            echartSetOption(o, t, function () {
                return {
                    ...
                    yAxis: {
                        ...
                        data: e,
                        axisLine: {
                            lineStyle: { show: !0, color: utils.getGrays()[300] },
                        },
                        axisTick: { show: !1 },
                        axisLabel: {
                            color: utils.getGrays()[500],
