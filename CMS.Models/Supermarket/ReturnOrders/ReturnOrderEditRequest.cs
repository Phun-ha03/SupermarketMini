...
{
    public class ReturnOrderEditRequest
    {
        ...
        public ReturnOrderEditRequest() { }
        public ReturnOrderEditRequest(ReturnOrder returnOrder)
        {
        ...
        public ReturnOrderEditRequest(ReturnOrderViewModel returnOrder)
        {
            ReturnID = returnOrder.ReturnID;
            OrderID = returnOrder.OrderID;
            ProductID = returnOrder.ProductID;
